...
public interface DecathlonInvoiceInfoDao extends JpaRepository<Isaf, String> {
	 ...
	 * @return
	 */
	@Query(value = "select " + "a.ISAF014 as invoiceDate," + "c.xmda033 as orderNum," + "b.isag010 as productName, "
			+ "b.isag009 as productNum," + "b.isag004 as qty," + "b.isag101 as unitPrice," + "a.isaf035 as invoiceNum,"
			+ "a.isaf011 as receivableNum " + "from dsdata.isaf_t a, dsdata.isag_t b , dsdata.xmda_t c "
			+ "where a.isafdocno=b.isagdocno and c.xmdadocno=b.isag019", nativeQuery = true)
...
//	Page<DecathlonInvoiceInfo> getAllInvoiceInfoPage();
	 ...
	 * @return
	 */
	@Query(value = "select " + "to_char(b.ISAF014,'yyyy/mm/dd') as invoiceDate," + "c.xmda033 as orderNum," // 訂單編號
			...
			+ "from  dsdata.isag_t a " + "left join  dsdata.isaf_t  b on a.isagdocno = b.isafdocno "
			...
			+ "and b.isafent='100' " + "and b.isafsite='TWVP' " + "and b.isafcomp='TWVP' "
//			+ "and b.isaf003 = 'K0064'", 
			+ "and b.isaf003 = :cusNo", nativeQuery = true)
	List<DecathlonInvoiceInfo> getInvoiceInfoByDateRange(@Param("start") String start, @Param("end") String end,
			@Param("cusNo") String cusNo);
