...
public interface WorkOrderProductionScheduleListDao extends JpaRepository<Isaf, String> {
	...
	@Query(value = "SELECT sfaadocno,oocq002,oocql004,sfaa020,sfaa012,sfaa013,sfaa019,sfaa050,gzcbl004,ooag011,imaal003,sfaa010,sfaa002,sfaastus,sfaa049,sfaa051,sfaa071  "
			...
			+ " LEFT JOIN  dsdata.gzcbl_t ON gzcbl002 = SUBSTR(oocq.oocq002,0,1)  AND gzcbl003= 'zh_TW' AND gzcbl001= '18009'"
			+ " LEFT JOIN DSDATA.IMAAL_T imaal " 
			+ " ON imaal.IMAAL001 = SFAA010 AND imaal.IMAALENT = :ENT "
			+ " LEFT JOIN DSDATA.ooag_T ooag "
			...
			+ " OFFSET :startRowNum ROWS FETCH NEXT :perPage ROWS ONLY "
			, nativeQuery = true)
	List<WorkOrderProductionScheduleInfo> getWorkOrderProductionScheduleListByArea(
			@Param("ENT") int ent,
			@Param("SITE") String site,
			@Param("SFAA020START") String sfaa020Start, //預計完工日 開始
			@Param("SFAA020END") String sfaa020End, //預計完工日 結束
